...
#创建文件
try:
f1 = open('D:\homework3\Blowing in the wind.txt','w')
...
with open('D:\homework3\Blowing in the wind.txt','r') as f2:
    line = f2.read().strip()
    l1 = line.split('\n')
...
with open('D:\homework3\Blowing in the wind.txt','w') as f3:
    f3.write('\n'.join(l1))

with open('D:\homework3\Blowing in the wind.txt','r') as f4:
    pages = f4.readlines()
    for i in pages:
        print(i)
